================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ToggleLangBar プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ToggleLangBar には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ToggleLangBar アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

ToggleLangBar.vcproj
...
ToggleLangBar.h
   ...
   CToggleLangBarApp アプリケーション クラスを宣言します。

ToggleLangBar.cpp
   これは、アプリケーション クラス CToggleLangBarApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ToggleLangBar.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル ToggleLangBar.rc に含まれていま
   す。

res\ToggleLangBar.rc2
...
ToggleLangBarDlg.h, ToggleLangBarDlg.cpp - ダイアログ
   これらのファイルは CToggleLangBarDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な ToggleLangBar.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   ToggleLangBar.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
